<?php $title = 'Edit Training Times'; include("includes/header.inc.php");   require 'includes/dbconnect.inc.php'; ?>

<article class="main_content">
  <div class="container" style="padding-bottom: 2.3%;">
    <h1 style="padding-top: 2%"> Edit Training Times</h1>
      ...
      <div class="col">
        <form action="includes/registerTimes.inc.php" method="post" style="padding-bottom:3%;">
          ...
          if (isset($_SESSION['userid'])) :
            ...
            $sql = "SELECT * FROM trainingtimes WHERE USERID = ? AND TRAININGTIMEID  = ? ORDER BY LAPDATE ASC";
            $stmt = mysqli_stmt_init($con);
            if (!mysqli_stmt_prepare($stmt, $sql)) {
              header("Location:../collegeroadswimming/editWeeklyTrainingTimes.php?error=sqlerror01");
              exit();
            }else
          ...
          <div>
            ...
            <button type="submit" class="btn btn-outline-dark my-2 my-sm-0" id="edit-day-submit" name="edit-day-submit" >Add New Times</button>
          </div>
          <?php
        endif;
      endif;
